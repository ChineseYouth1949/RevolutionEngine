...
//=======================================================================================================
// RE_FINLINE implementations
//

RE_FINLINE bool Frustum::IntersectSphere(BoundingSphere sphere) const {
...
RE_FINLINE bool Frustum::IntersectBoundingBox(const AxisAlignedBox& aabb) const {
  for (int i = 0; i < 6; ++i) {
...
RE_FINLINE Frustum operator*(const OrthogonalTransform& xform, const Frustum& frustum) {
  Frustum result;
...
RE_FINLINE Frustum operator*(const AffineTransform& xform, const Frustum& frustum) {
  Frustum result;
...
RE_FINLINE Frustum operator*(const Matrix4& mtx, const Frustum& frustum) {
  Frustum result;
