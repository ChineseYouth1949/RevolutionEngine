...
class BoundingPlane {
 public:
  ...
  RE_FINLINE operator Vector4() const { return m_repr; }
...
//
RE_FINLINE BoundingPlane::BoundingPlane(Vector3 pointOnPlane, Vector3 normalToPlane) {
...
//
RE_FINLINE BoundingPlane PlaneFromPointsCCW(Vector3 A, Vector3 B, Vector3 C) {
