...
class DynamicDescriptorHeap {
 public:
  ...
  RE_FINLINE void CommitGraphicsRootDescriptorTables(ID3D12GraphicsCommandList* CmdList) {
  ...
  RE_FINLINE void CommitComputeRootDescriptorTables(ID3D12GraphicsCommandList* CmdList) {
